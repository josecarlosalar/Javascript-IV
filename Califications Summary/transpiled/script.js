...
var summarizeClassRoom = function (studentList) {
    ...
    for (var _i = 0, studentList_1 = studentList; _i < studentList_1.length; _i++) {
        ...
        average = Number(((student.califications.reduce(function (a, b) { return a + b; }, 0)) / student.califications.length).toPrecision(3));
        arr.push({ name: student.name, highestCalification: student.califications.sort().reverse()[0], averageCalifications: average });
    }
    return arr;
};
